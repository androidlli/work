...
public class GroupFragment extends BaseFragment implements GroupContract.View, GroupAdapter.OnSelectCountListener {
    ...
    TextView tvMember4;
    @BindView(R.id.tv_member5)
    TextView tvMember5;
    @BindView(R.id.tv_member6)
    TextView tvMember6;
    @BindView(R.id.avl_login_indicator)
    AVLoadingIndicatorView mLoadView;

    @OnClick({R.id.iv_open_member_list, R.id.tv_confirm, R.id.tv_open_group_leader, R.id.tv_ensure,R.id.ll_detele})
...
//                break;
    ...
    protected void initView() {
        ...
        if (ADD.equals(mType)) {
            ...
            llDetele.setVisibility(View.VISIBLE);
        } else {
...
//        datas = getDatas();
    ...
    public void onSelectCount(List<Member> members, int selectSize) {
        ...
        if (selectSize == 0) {
            ...
            tvMember5.setVisibility(View.INVISIBLE);
            tvMember6.setVisibility(View.INVISIBLE);
            ...
            tvMember3.setText(members.get(2).getName());
            tvMember4.setText(members.get(3).getName());
            tvMember5.setText(members.get(4).getName());
            tvMember1.setVisibility(View.VISIBLE);
            tvMember2.setVisibility(View.VISIBLE);
            tvMember3.setVisibility(View.VISIBLE);
            tvMember4.setVisibility(View.VISIBLE);
            tvMember5.setVisibility(View.VISIBLE);
            tvMember6.setVisibility(View.INVISIBLE);
        }else {
            tvMember1.setText(members.get(0).getName());
            tvMember2.setText(members.get(1).getName());
            ...
            tvMember4.setText(members.get(3).getName());
            tvMember5.setText(members.get(4).getName());
            tvMember6.setText(members.get(5).getName());
            tvMember1.setVisibility(View.VISIBLE);
            tvMember2.setVisibility(View.VISIBLE);
            tvMember3.setVisibility(View.VISIBLE);
            tvMember4.setVisibility(View.VISIBLE);
            tvMember5.setVisibility(View.VISIBLE);
            tvMember6.setVisibility(View.VISIBLE);
        }
    }
...
//        mAdapter.setNewData(members);
        mAdapter.setNewDataNoError(members);
