...
//    Observable<TaskAbandon> taskArrange(@Query("userid") int userId, @Query("groupid") int groupId, @Body List<TaskManageList.DataBean.TaskListBean> taskListBeanList);
    ...
    //POST /trailer/taskmanagerread?ApiToken={APITOKEN} 任务阅读
    @POST("trailer/taskmanagerread")
    Observable<TaskAbandon> taskManagerRead(@Body Map<String,Object> objectMap);
}
