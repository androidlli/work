...
public class TrajectoryFragment extends BaseFragment implements TrajectoryContract.View {
    ...
    public static TrajectoryFragment newInstance(String imei, Date startTime, Date endTime) {
...
//        mActivity.getSupportActionBar().setHomeAsUpIndicator(R.drawable.back);
    ...
    protected void initData() {
        mActivity = (TrajectoryActivity) getActivity();
    ...
    @Override
    public void setPresenter(TrajectoryContract.Presenter presenter) {
