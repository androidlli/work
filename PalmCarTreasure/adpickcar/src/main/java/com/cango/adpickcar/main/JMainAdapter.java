...
public class JMainAdapter extends BaseAdapter<CarTakeTaskList.DataBean.CarTakeTaskListBean> {
    private MainFragment mainFragment;

    public JMainAdapter(Context context, List<CarTakeTaskList.DataBean.CarTakeTaskListBean> datas, boolean isOpenLoadMore, MainFragment mainFragment) {
